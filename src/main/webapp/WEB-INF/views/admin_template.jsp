	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="/" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini" style="color: red;"><b>MUF</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"> <img
					src="https://contattafiles.s3.us-west-1.amazonaws.com/tnt12212/TzYzqO_tSxjRxEN/Mandiri-Utama-Finance.png"
					alt="muf" width="150" height="55">
			</span>
			</a>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="${pageContext.request.contextPath }/"><i
							class="fa fa-user-o "></i> User</a></li>
